...
class DuizhangDaili extends React.Component{
    ...
    handleClick(name){
        ...
        if(this.props.countState["chosenBaobiao"] === 'Duizhang'){
            this.props.history.push("/DuizhangBaobiao")
        }
        else if(this.props.countState["chosenBaobiao"] === 'Dinghuo'){
            this.props.history.push("/DinghuoBaobiao")
        }
        else if(this.props.countState["chosenBaobiao"] === 'Waibao'){
            this.props.history.push("/WaibaoBaobiao")
        }
...
export default connect(mapStateToProps,mapDispatchToProps)(DuizhangDaili);