...
class WaibaoDetail extends React.Component{
    constructor(){
        super()
        this.state = {
            Orders:[]
    ...
    return(
        <div>
            ...
            <List>
                ...
                <Item extra={moment(this.state.Orders["SYS_DATE"]).format("YYYY-MM-DD hh:mm:ss")}>交易时间</Item>
...
export default connect(mapStateToProps,mapDispatchToProps)(WaibaoDetail);